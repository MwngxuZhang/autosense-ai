...
3. 面试官或项目评审者：判断项目是否具备真实业务价值和落地可行性。
...
1. 我不是做一个泛化AI助手，而是选择车载智驾传感器这个垂直场景。
2. 这个场景中产品经理需要同时处理市场、客户、技术、研发、测试和售前协作。
3. 我把核心工作流拆成市场情报、需求拆解、竞品对比、产品方案和AI评测五个模块。
4. AI不是替代决策，而是辅助生成初稿，并通过来源追溯和人工评分控制质量。
5. 我设计了需求拆解准确率、幻觉率、来源可追溯率、人工采纳率等指标，体现AI产品经理的数据化迭代思路。
